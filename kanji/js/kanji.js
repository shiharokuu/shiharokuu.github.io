var kCollection = [
 ...
 ['万','丈','三','上','下','丸','久','亡','凡','刃','千','口','土','士','夕','大','女','子','寸','小','山','川','工','己','干','弓','才','之','巾','乞','于','也','々','勺'],
 ...
 ['出','世','付','仕','代','仙','他','以','令','兄','只','史','号','叶','𠮟','叱','加','占','可','句','司','召','台','古','右','石','四','囚','凸','凹','冬','処','皮','奴','功','巧','包','去','圧','庁','広','刊','北','半','外','央','失','矢','尻','尼','左','布','平','幼','弁','必','打','払','斥','丘','未','末','本','札','正','母','民','氷','永','汁','氾','犯','生','主','玉','巨','用','冊','田','由','甲','申','白','旧','旦','甘','皿','目','且','矛','示','礼','写','立','市','穴','它','玄','辺','込','弘','瓦','丼','丙'],
    ...
    ***************************************************************************** */
    ...
    (function (Kanji) {
		...
		//Kanji Mnemonic
            ...
            kanjiMnemonic.innerHTML = kanjiData.meaning_mnemonic;
		...
		function createGrid(rawKanji){
			...
			var strokeCount = findStroke(kCode);
			var code = ""
