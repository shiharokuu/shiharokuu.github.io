    ...
    ***************************************************************************** */
    ...
    (function (Kanji) {
        ...
        function createKanjiRow(kanjiId) {
            const numHintKanjiBoxes = 13;
            const numEmptyKanjiBoxes = 65;
		...
		// kanji stroke order
            ...
            kanjiBlock.appendChild(kanjiStrokeOrder);
		...
		//Kanji Mnemonic
            ...
            kanjiBlock.appendChild(kanjiMnemonic);
