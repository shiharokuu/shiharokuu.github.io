...
//HTML GENERATOR
	const variant1 = "#2cae00";
	const variant2 = "#2cae00"; 
...
//Create IMG
	...
	imgCredit.setAttribute("href", "https://digimonworldai.foroactivo.com/u109");
	...
	img.setAttribute("alt", "Firma by Damian/Kenta/Shiharoku");
	img.setAttribute("title", "Firma by Damian/Kenta/Shiharoku");
...
//Create statTip
	...
	statsTip.innerHTML = "<ruby><rb>佐賀石 諦要</rb><rp>（</rp><rt>Sagaseki Taiyō</rt><rp>）</rp></ruby>";
